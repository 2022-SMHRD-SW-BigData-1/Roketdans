...
public class User_Pokemon {
	...
	Pokemons wild_ggobugi = new Pokemons("꼬부기", "로케드박치기","물", "rd");
	Pokemons wild_pairi = new Pokemons("파이리", "플레어드라이브","불", "rd");
	Pokemons wild_isanghassi = new Pokemons("이상해씨", "씨폭탄","풀", "rd");
